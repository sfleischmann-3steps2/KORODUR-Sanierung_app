...
export default function IndustriebauPage() {
  const kategorie = kategorien.find((k) => k.id === "industriebau")!;
  ...
  return (
    <>
      ...
      {kategorie.unterkategorien.map((sub) => {
        const refs = getReferenzenByUnterkategorie("industriebau", sub.id);
        return (
          <section
            key={sub.id}
            className="bg-[#f5f5f6]"
