...
export const referenzenFR: Record<string, {
  ...
  "trinkwasser-hochbehaelter": {
    ...
    loesung:
      "Remise en état avec le système complet MICROTOP, adapté aux zones fonctionnelles (égalisation, reprofilage, pont d'adhérence, consolidation de surface).",
    vorteile: [
  ...
  "trinkwasserturm-budapest": {
    ...
    loesung:
      "Le système minéral MICROTOP a été utilisé, plus précisément les produits TW BM et TW 02, sur une phase de rénovation d'environ six mois.",
    vorteile: [
